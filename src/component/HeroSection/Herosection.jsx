  ...
  return (
    <div id='about' className="hero-container">
      ...
      <div className="hero-container-social-icons">
        <FontAwesomeIcon icon={faGithub} className="hero-container-icon" onClick={openGithubProfile} />
        <FontAwesomeIcon icon={faLinkedin} className="hero-container-icon" onClick={openLinkedInProfile} />
      </div>
    </div>
  );
};
